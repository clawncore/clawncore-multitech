...
import { ArrowRight, X, Cpu, Activity } from 'lucide-react';
          ...
          <div className="relative overflow-hidden rounded-3xl border border-gray-200 bg-white p-8 shadow-lg">
            ...
            >
              <div className="flex items-center space-x-3 mb-6">
                <div className="p-2 bg-nvidia-500/10 rounded-lg">
                  <Cpu size={20} className="text-nvidia-500" />
                </div>
                <span className="text-xs font-mono font-medium text-nvidia-500/80 tracking-widest uppercase">
                  Active Module
                </span>
              </div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                  ...
                  <div className="text-sm font-medium text-gray-900">{activeModule.status}</div>
                </div>
                ...
                <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                  ...
                  <div className="flex items-center">
                    <div className="text-sm font-medium text-gray-900 mr-3">{activeModule.confidence}%</div>
              ...
              <Button
                className="w-full bg-nvidia-500 hover:bg-nvidia-600 text-black h-12 rounded-xl transition-all duration-300 font-medium tracking-wide"
              >
                Access Dashboard
