...
-- Drones
('ClawnAgri X4 Drone', 'Professional agricultural drone with multispectral camera, 45-min flight time, and crop analysis. Covers 50 acres per flight.', 4999.00, 5999.00, ARRAY['https://images.unsplash.com/photo-1713952160156-bb59cac789a9?auto=format&fit=crop&w=600&q=80'], 'drones', 'mapping', 15, true, 4.80, 234, ARRAY['drone', 'multispectral', 'mapping']),
('ClawnAgri Mini Sprayer', 'Compact drone sprayer for targeted pesticide and fertilizer application. 10L tank, GPS-guided precision.', 2499.00, 2999.00, ARRAY['https://images.unsplash.com/photo-1713952152768-5f28b8093166?auto=format&fit=crop&w=600&q=80'], 'drones', 'spraying', 22, true, 4.60, 189, ARRAY['drone', 'sprayer', 'precision']),
('Scout Pro 200', 'Lightweight scouting drone for crop monitoring. Real-time video feed, thermal imaging, 30-min flight.', 1899.00, NULL, ARRAY['https://images.unsplash.com/photo-1713952160156-bb59cac789a9?auto=format&fit=crop&w=600&q=80'], 'drones', 'scouting', 30, false, 4.50, 156, ARRAY['drone', 'scouting', 'thermal']),
('ClawnAgri Heavy Lift', 'Industrial drone for heavy payload delivery. 20kg capacity, 60-min flight, GPS navigation.', 7999.00, 9499.00, ARRAY['https://images.unsplash.com/photo-1713952152768-5f28b8093166?auto=format&fit=crop&w=600&q=80'], 'drones', 'delivery', 8, true, 4.90, 98, ARRAY['drone', 'heavy-lift']),

-- Seeds
('ClawnSeed Pro Wheat', 'High-yield dwarf wheat variety. Disease-resistant, drought-tolerant. 15% above average yield. 10kg bag.', 89.00, 109.00, ARRAY['https://images.unsplash.com/photo-1437252611977-07f74518abd7?auto=format&fit=crop&w=600&q=80'], 'seeds', 'grains', 500, true, 4.70, 412, ARRAY['wheat', 'high-yield', 'drought-resistant']),
