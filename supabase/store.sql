...
('Scout Pro 200', 'Lightweight scouting drone for crop monitoring. Real-time video feed, thermal imaging, 30-min flight.', 1899.00, NULL, ARRAY['https://images.unsplash.com/photo-1724355574973-1c06f4e6c918?auto=format&fit=crop&w=600&q=80'], 'drones', 'scouting', 30, false, 4.50, 156, ARRAY['drone', 'scouting', 'thermal']),
('ClawnAgri Heavy Lift', 'Industrial drone for heavy payload delivery. 20kg capacity, 60-min flight, GPS navigation.', 7999.00, 9499.00, ARRAY['https://images.unsplash.com/photo-1473968512647-3e447244af8f?auto=format&fit=crop&w=600&q=80'], 'drones', 'delivery', 8, true, 4.90, 98, ARRAY['drone', 'heavy-lift']),
